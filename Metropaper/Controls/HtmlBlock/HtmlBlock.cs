...
namespace WeiranZhang.Metropaper.Controls
{
    ...
    public class HtmlBlock : Control
    {
        ...
        static HtmlBlock()
        {
            ...
            BookmarkViewModelProperty = DependencyProperty.Register("BookmarkViewModel", typeof(BookmarkViewModel), typeof(HtmlBlock), new PropertyMetadata(BookmarkModelChanged));
        ...
        {
            var instance = (HtmlBlock)o;
            var bookmarkViewModel = (BookmarkViewModel)e.NewValue;
            if (instance.internalItemsControl != null)
                instance.AppendHtml(bookmarkViewModel.GetBodyFromStorage());
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (BookmarkViewModel != null)
            {
                ...
                else
                {
                    ...
                    {
                        internalItemsControl.Items.Add(textBox);
                    }
                }
            }
        }
        ...
        private void AddNewTextBox(HtmlNode childNode, int leftMargin = 0, int topMargin = 0, int rightMargin = 0, int bottomMargin = 20)
        {
            int _leftMargin = 0;
            int _rightMargin = 0;
            int _topMargin = 0;
            ...
            switch (childNode.Name)
            {
                ...
                case "img":
                case "image":
                    bottomMargin = 0; // override default bottom
                    break;
                case "div":
                    if (childNode.ChildNodes.Count(n => n.Name == "p" || n.Name == "img") == 0)
                        bottomMargin = 20;
                    else
                        bottomMargin = 0;
                    break;
            ...
            _currentRichTextBox.Margin = new Thickness(leftMargin + _leftMargin, 
